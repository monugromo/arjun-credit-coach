    ...
    <section className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      <div className="relative bg-primary-deep/5 px-4 pb-4 pt-4">
        ...
        <div className="pointer-events-none absolute -right-14 -top-1 h-[132px] w-40 overflow-hidden">
          <img src={novioCardArt.url} alt="SBM Novio Credit Card" loading="lazy" width={1209} height={1920} className="absolute right-[56px] top-0 w-[100px] origin-bottom-right rotate-[80deg] rounded-lg drop-shadow-lg" />
        </div>
        <p className="text-[11px] font-bold uppercase tracking-wide text-muted-foreground">Why this fits you</p>
        <div className="mt-2 flex flex-wrap gap-2">
